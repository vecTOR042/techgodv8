...
### 3.
#### COPY THESE COMMANDS AND PASTE IF YOU TRYING TO DEPLOY [HAX3R BUG BOT] (https://github.com/HAX3R302/techgod)) ON ANY TERMINAL
...
```
```
git clone https://github.com/HAX3R302/techgod
```
```
cd techgodv8
yarn install 
